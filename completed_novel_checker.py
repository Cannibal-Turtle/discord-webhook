...
def build_paid_completion(novel, chap_field, chap_link, duration: str):
    ...
    return (
        ...
        f"{divider_line}\n"
        f"***<a:kikilts_bracket:1365693072138174525>[{title}]({link})<a:lalalts_bracket:1365693058905014313> — officially completed!*** <a:cowiggle:1368136766791483472><a:whitesparkles:1365569806966853664>\n\n"
...
def build_free_completion(novel, chap_field, chap_link):
    ...
    return (
        ...
        f"{divider_line}\n"
        f"***<a:kikilts_bracket:1365693072138174525>[{title}]({link})<a:lalalts_bracket:1365693058905014313>— complete access granted!*** <a:cowiggle:1368136766791483472><a:whitesparkles:1365569806966853664>\n\n"
