...
def build_paid_completion(novel, chap_field, chap_link, duration: str):
    ...
    return (
        ...
        "◈· ─ · ─ · ─ · ❁ · ─ ·𖥸· ─ · ❁ · ─ · ─ · ─ ·◈\n"
        f"***『[{title}]({link})』— officially completed!*** <a:turtle_super_hyper:1365223449827737630>\n\n"
...
def build_free_completion(novel, chap_field, chap_link):
    ...
    return (
        ...
        "◈· ─ · ─ · ─ · ❁ · ─ ·𖥸· ─ · ❁ · ─ · ─ · ─ ·◈\n"
        f"***『[{title}]({link})』— complete access granted!*** <a:turtle_super_hyper:1365223449827737630>\n\n"
